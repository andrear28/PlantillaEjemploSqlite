    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Post</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Administracion <small>del post</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-users fa-fw"></i> Post</h3>
                            </div>
                        ...
                        <table id="grid-basic" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="Utc" data-width="25%">Utc</th>
                                    <th data-column-id="Anio" data-width="25%">Anio</th>
                                    <th data-column-id="Mes" data-width="20%">Mes</th>
                                    ...
                                    <th data-column-id="SubTitulo" data-width="20%">SubTitulo </th>
